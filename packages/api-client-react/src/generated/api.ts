...
export const shipTransfer = async (id: number,
  ...
  return customFetch<Transfer>(getShipTransferUrl(id),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(shipTransferInput)
  }
);}
...
export const receiveTransfer = async (id: number,
  ...
  return customFetch<Transfer>(getReceiveTransferUrl(id),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(receiveTransferInput)
  }
);}
...
export const createStoreRequest = async (createStoreRequestInput: CreateStoreRequestInput, options?: RequestInit): Promise<StoreRequestWithItems> => {
  ...
  return customFetch<StoreRequestWithItems>(getCreateStoreRequestUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(createStoreRequestInput)
  }
);}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetStoreRequestQueryKey(id);
   ...
   return  { queryKey, queryFn, enabled: id !== null && id !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getStoreRequest>>, TError, TData> & { queryKey: QueryKey }
}
...
export const rejectStoreRequest = async (id: number,
  ...
  return customFetch<StoreRequestWithItems>(getRejectStoreRequestUrl(id),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(rejectStoreRequestInput)
  }
);}
...
export const completeProductionBatch = async (id: number,
  ...
  return customFetch<ProductionBatch>(getCompleteProductionBatchUrl(id),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(completeBatchInput)
  }
);}
